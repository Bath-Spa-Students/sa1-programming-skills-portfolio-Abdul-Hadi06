...
second_number = 10
# Declare a third variable, and initialize its initial value with the integer 25.
third_number = 25
#Initialize the fourth variable with an integer number which have a value 64.
forth_number = 64
#Take the sum of those four integers and assign it into a new variable.
